...
?>
	...
	<div class="row align-items-start justify-content-start h-100 categoria_card">
		...
		?>
			...
			<div id="card_<?php the_ID(); ?>" class="col-md-4 style_card">
    <a href="<?php the_permalink(); ?>">
        <div class="card h-100 text-start">
            <a href="<?php the_permalink(); ?>">
                <div class="card-header" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID(), 'large')); ?>')">
                </div>
            </a>
            <div class="card-body">
                <a href="<?php the_permalink(); ?>">
                    <h3><?php the_title(); ?></h3>
                    <p class="text-al"><?php echo wp_trim_words(get_the_content(), 20, '...'); ?></p>
                </a>
            </div>
